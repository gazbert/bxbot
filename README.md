...
[Kraken](https://www.kraken.com), [Gemini](https://gemini.com/), and [Coinbase](https://www.coinbase.com/advanced-trade) are included. 
...
1. Fetch the BX-bot image from [Docker Hub](https://hub.docker.com/r/gazbert/bxbot/): `docker pull gazbert/bxbot:2.2.1`
1. Run the Docker container: `docker container run --publish=8080:8080 --name bxbot-2.2.1 -it gazbert/bxbot:2.2.1 bash`
