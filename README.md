...
1. Fetch the BX-bot image from [Docker Hub](https://hub.docker.com/r/gazbert/bxbot/): `docker pull gazbert/bxbot:1.6.0`
1. Run the Docker container: `docker container run --publish=8080:8080 --name bxbot-1.6.0 -it gazbert/bxbot:1.6.0 bash`
